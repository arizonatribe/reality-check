...
class DogClass extends AnimalClass {
  constructor() {
    ...
    this.getQualities = this.getQualities.bind(
      this, [
        "excitable",
        "loveable",
        "smelly",
...
test("singleMethodTests", benchmark => {
  benchmark(
    () => {
...
test("doubleMethodTests", benchmark => {
  benchmark(
    () => {
      const dog = new DogClass()
  ...
  benchmark(
    () => dogObj.makeSound() + dogObj.eatFood(),
    "Object composition"
  )
})

test("tripleMethodTests", benchmark => {
  benchmark(
    () => {
      const dog = new DogClass()
  ...
  benchmark(
    () => dogObj.makeSound() + dogObj.eatFood() + dogObj.getQualities(),
    "Object composition"
  )
})
